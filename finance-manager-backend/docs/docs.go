...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/calc-savings": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "the request to calculate",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/restmodels.SavingsCalculationRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "restmodels.SavingsCalculationRequest": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
                ...
                "payFrequency": {
                    "$ref": "#/definitions/payfrequency.PayFrequency"
                }
            }
        },
